...
namespace Clean_Connect.Persistence.Migrations
{
    ...
    [Migration("20260618194212_AutoMigration_Pending")]
    partial class AutoMigration_Pending
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clean_Connect.Domain.Entities.Coupon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Clean_Connect.Domain.Entities.Escrow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Clean_Connect.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("Clean_Connect.Domain.Entities.Coupon", "Coupon")
                        .WithMany()
            ...
            modelBuilder.Entity("Clean_Connect.Domain.Entities.Client", b =>
                {
                    b.HasOne("Clean_Connect.Domain.Entities.Client", "ReferredBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Clean_Connect.Domain.Entities.Escrow", b =>
                {
                    b.HasOne("Clean_Connect.Domain.Entities.Booking", "Booking")
                        .WithOne()
                        .HasForeignKey("Clean_Connect.Domain.Entities.Escrow", "BookingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Clean_Connect.Domain.Entities.Payment", "Payment")
                        .WithOne()
                        .HasForeignKey("Clean_Connect.Domain.Entities.Escrow", "PaymentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Clean_Connect.Domain.Entities.ApplicationUser", null)
                        .WithMany()
